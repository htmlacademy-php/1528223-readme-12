    ...
    <form class="registration__form form" action="registration.php" method="post" enctype="multipart/form-data">
      <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
          <div class="registration__input-wrapper form__input-wrapper <?php if($errors['email']): ?>form__input-section--error<?php endif; ?>">
            ...
            <div class="form__input-section">
              <input class="registration__input form__input" id="registration-email" type="text" name="email" placeholder="Укажите эл.почту" value="<?=getPostVal('email')?>">
          ...
          <div class="registration__input-wrapper form__input-wrapper <?php if($errors['login']): ?>form__input-section--error<?php endif; ?>">
          ...
          <div class="registration__input-wrapper form__input-wrapper <?php if($errors['password']): ?>form__input-section--error<?php endif; ?>">
            <label class="registration__label form__label" for="registration-password">Пароль<span class="form__input-required">*</span></label>
            <div class="form__input-section">
              <input class="registration__input form__input" id="registration-password" type="password" name="password" placeholder="Придумайте пароль" value="<?=getPostVal('password')?>">
              <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
              <div class="form__error-text">
          ...
          <div class="registration__input-wrapper form__input-wrapper <?php if($errors['password-repeat']): ?>form__input-section--error<?php endif; ?>">
            ...
            <div class="form__input-section">
              <input class="registration__input form__input" id="registration-password-repeat" type="password" name="password-repeat" placeholder="Повторите пароль" value="<?=getPostVal('password-repeat')?>">
              <button class="form__error-button button" type="button">!<span class="visually-hidden">Информация об ошибке</span></button>
              <div class="form__error-text">
                <h3 class="form__error-title"><?=errors_content($errors, 'password-repeat', 'subhead')?></h3>
                <p class="form__error-desc"><?=errors_content($errors, 'password-repeat', 'submes')?></p>
              </div>
            </div>
          </div>
        </div>
